...
export default function NewTicketPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Create ticket (ticket_code will be auto-generated by DB trigger)
    ...
    return (
      <div className="max-w-2xl mx-auto space-y-6">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-bold text-slate-900">Ticket Created!</h1>
        ...
        <div className="card">
          <div className="p-6 border-b border-slate-200">
            <h3 className="font-semibold text-slate-900">Ticket Code</h3>
          ...
          <div className="p-6">
            <div className="flex items-center gap-3">
              <div className="flex-1 p-4 bg-slate-100 rounded-lg border border-slate-200">
